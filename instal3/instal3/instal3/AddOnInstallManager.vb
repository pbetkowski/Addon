...
Namespace AddOnInstaller
  ...
  Public Class AddOnInstallManager
    ...
    '/// <summary>
        '/// Path of the AddOnInstallAPI_x64.dll.
        '/// </summary>
        ...
        ' Declaring the functions inside "AddOnInstallAPI_x64.dll"
...
#If Version = "2005" Then
        ...
        Declare Function EndInstallEx Lib "AddOnInstallAPI_x64.dll" (ByVal strPath As String, ByVal isSucceed As Boolean) As Int32

        'EndUninstall - Signals B1 that the uninstallation is complete
        Declare Function EndUninstall Lib "AddOnInstallAPI_x64.dll" (ByVal strPath As String, ByVal isSucceed As Boolean) As Int32

        'B1Info - Gets B1 Version information
        Declare Function B1Info Lib "AddOnInstallAPI_x64.dll" (ByVal strB1Info As String, ByVal maxLen As Int32) As Int32
        ...
        Public Function InitParams() As Boolean
            ...
            If NumOfParams = 2 Then
                ...
                Else
                    ...
                    ' Get the "AddOnInstallAPI_x64.dll" path
...
#End If
        ...
        Public Sub Install()
            ...
            Try
                ...
                ' Call AddOnInstallAPI_x64.dll functions to inform B1 about the installation
...
#End If
        ...
        '/// <summary>
        '/// Calls AddOnInstallAPI_x64.dll functions needed to complete the installation.
        '/// </summary>
